...
public class PaymentCommonController {
    ...
    public ResponseEntity<SuccessResponseDto<PaymentStartCheckResponseDto>> checkPayment(
        ...
        SuccessResponseDto<PaymentStartCheckResponseDto> response = SuccessResponseDto.create(
            paymentStartCheckResponseDto);
    ...
    public ResponseEntity<SuccessResponseDto<PaymentStatusResponseDto>> endCheck(
        ...
        PaymentStatusResponseDto statusResponse = paymentCommonService.checkPaymentStatus(
            request.paymentId(),
            principle.getUser());
        SuccessResponseDto<PaymentStatusResponseDto> response = SuccessResponseDto.create(
            statusResponse);
        return ResponseEntity.ok(response);
    }
